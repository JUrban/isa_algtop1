...
proof -
  ...
  have hK_fab_raw: "top1_is_free_abelian_group_full_on ?K ?mulAG ?eAG ?invgAG
    ...
    sorry \<comment> \<open>K free abelian on {..<m}-{0} with generators \<phi>\_bar(\<iota>A s).
       Cannot use free\_abelian\_invariant\_under\_iso (type mismatch K_0/K).
       Need direct proof: abelian (K\<subseteq>abelian AbelG), generators in K (\<phi>\_bar(\<iota>A s) \<in> K
       for s>0 since \<epsilon>_0(\<iota>A s)=0), injective (\<phi>\_bar inj on K_0 + \<iota>A inj),
       generation (K = \<phi>\_bar(K_0) and K_0 generated by \<iota>A on {..<m}-{0}),
       independence (difference coordinates \<delta>_j per expert audit 11).\<close>
