...
proof -
  ...
  next
    ...
    show ?thesis sorry \<comment> \<open>Assembly: verify 5 conditions of top1\\_is\\_free\\_group\\_full\\_on.
       Each condition reduces to finite sub-wedge via hloop\\_finite/hhtpy\\_finite.\<close>
  qed
qed
