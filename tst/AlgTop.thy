        ...
        proof (intro conjI)
          ...
          show "top1_fundamental_group_carrier Y TY y0 =
              top1_subgroup_generated_on
                ...
                (top1_fundamental_group_id Y TY y0) (top1_fundamental_group_invg Y TY y0)
                (gen ` ?NT)"
            sorry \<comment> \<open>Every loop is in \\<pi>\\_1 of finite subgraph (compactness) \\<Rightarrow> generated by gen.\<close>
          ...
          show "\<forall>ws::('a set \<times> bool) list.
              ...
              top1_fundamental_group_id Y TY y0"
            sorry \<comment> \<open>Word involves finitely many generators \\<Rightarrow> lives in finite subgraph
               \\<Rightarrow> free there (harc\\_loops\\_free) \\<Rightarrow> nontrivial word \\<ne> id.\<close>
        qed
        thus ?thesis by (by100 blast)
      qed
    qed
