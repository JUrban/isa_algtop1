        ...
        proof (rule InterI)
          ...
          proof -
            ...
            show "{k. top1_loop_equiv_on ?U ?TU a
                (top1_basepoint_change_on ?U ?TU ?b a ?rev\<delta> f0) k} \<in> N"
              sorry \<comment> \<open>Requires: (1) S1 def retract of B2-{0} (sorry'd helper),
                   (2) h factors through S1 via retraction,
                   (3) (h|_{S1})_* image = \<langle>kp_class\<rangle> \<subseteq> N.\<close>
          qed
