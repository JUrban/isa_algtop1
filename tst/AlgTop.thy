  ...
  proof -
    ...
    proof -
      ...
      proof (rule ccontr)
        ...
        have "top1_path_connected_on S2C_here TS2C_here"
          sorry \<comment> \<open>PC_w \<union> W2 \<supseteq> W1\<union>W2 = S2C. PC_w\<union>W2 connected (Theorem_23_3). S2C pc.\<close>
