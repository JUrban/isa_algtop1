        ...
        proof (intro conjI)
          ...
          show "top1_fundamental_group_carrier Y TY y0 =
              top1_subgroup_generated_on
                ...
                (top1_fundamental_group_id Y TY y0) (top1_fundamental_group_invg Y TY y0)
                (gen ` ?NT)"
            sorry \<comment> \<open>Every loop has compact image meeting finitely many arcs (hcompact\\_in\\_finite).
               So every [f] \\<in> \\<pi>\\_1(Y) is in \\<pi>\\_1(T \\<union> \\<Union>F) for finite F \\<subseteq> ?NT.
               By harc\\_loops\\_free: \\<pi>\\_1(T\\<union>\\<Union>F) is generated by gen|F.
               By inclusion: gen|F \\<subseteq> gen|?NT. So [f] \\<in> \\<langle>gen|?NT\\<rangle>.\<close>
