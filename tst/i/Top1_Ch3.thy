...
text \<open>Theorem 28.2: (1) compact → (2) lp-compact → (3) seq-compact → (1).
  Part (1)→(2) is Theorem_28_1. Parts (2)→(3) and (3)→(1) need metric arguments.\<close>
    ...
    next
      ...
      next
        ...
        proof (intro conjI allI impI)
          ...
          proof -
            obtain n :: nat where hn: "real n > 1 / e" using he
              by (meson less_imp_inverse_less reals_Archimedean2)
            have hn2: "real (n + 2) > 1 / e" using hn by linarith
