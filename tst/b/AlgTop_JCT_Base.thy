...
proof (rule ccontr)
  ...
  have hg_cont: "top1_continuous_map_on ?S2
    ...
    sorry \<comment> \<open>g = diff/||diff|| is continuous S^2→S^1: standard composition of continuous functions
       with nonzero denominator. Range in S^1 since normalized. Bridge via subspace topologies.\<close>
