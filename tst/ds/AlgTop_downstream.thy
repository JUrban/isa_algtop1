...
lemma theorem_76_1_paste_chain_proper:
  ...
  using theorem_76_1_paste_chain[OF hq hfresh_c ha_fresh_u2 ha_fresh_v] .
...
proof -
  ...
  have ha_u2: "a \<notin> fst ` set u2" and ha_v: "a \<notin> fst ` set v"
    sorry \<comment> \<open>Needs a-freshness. Proper version handles this.\<close>
  from theorem_76_1_paste_chain[OF assms hfresh ha_u2 ha_v]
...
proof -
  ...
  from theorem_76_1_paste_chain_proper[OF hq hfresh_c ha_fresh_u2 ha_fresh_v]
  have h1: "top1_quotient_of_scheme_on Y TY
    ([(c, True)] @ rev (map top1_inverse_edge u2) @ v @ [(c, True)])" .
...
proof -
  ...
  have hcore: "top1_quotient_of_scheme_on Y TY
    ...
    sorry \<comment> \<open>Needs a-freshness for cut\\_flip\\_paste\\_core. Not on critical path.\<close>
